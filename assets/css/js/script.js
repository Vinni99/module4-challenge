...
function showResult(){
    ...
    if (userScore > 3){ 
        ...
        var scoreTag = 'and congrats! , You got' + userScore + 'out of' + questions.length;
        scoreText.innerHTML = scoreTag;  
    }
    else if(userScore > 1){ 
        var scoreTag = 'and nice, You got' + userScore + 'out of' + questions.length;
        scoreText.innerHTML = scoreTag;
    }
    else{ 
        var scoreTag = 'and sorry, You got only' + userScore + ' out of' + questions.length;
        scoreText.innerHTML = scoreTag;
    }
}
...
function queCounter(index){
    ...
    var totalQueCountTag = '<span><p>'+ index +'</p> <p>'+ questions.length +'</p> Questions</span>';
